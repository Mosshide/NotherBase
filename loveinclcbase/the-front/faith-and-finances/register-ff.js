export default async function submitApplication(req, user) {
    ...
    if (Date.now() - req.session.lastFFRegistration < 60 * 1000) return "Please wait before trying to register for this course again.";
        ...
        req.db.Spirit.create("faith-and-finances-0325", newRegistration);

        // req.db.SendMail.send("wyattsushi@gmail.com", `New Registration for Faith and Finance Course 2025`, `
        req.db.SendMail.send("exec.director@loveincoflewiscounty.org", `New Registration for Faith and Finance Course 2025`, `
            <h1>New Registration for Faith and Finance Course 2025</h1>
